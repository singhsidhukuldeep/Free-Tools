import { b as c } from "./index-CZ_NjNk8.js";
var E = { exports: {} };
(function(h, j) {
  (function(p, i) {
    i();
    ...
    function p(e, t) {
      return typeof t > "u" ? t = { autoBom: false } : typeof t != "object" && (console.warn("Deprecated: Expected third argument to be a object"), t = { autoBom: !t }), t.autoBom && /^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type) ? new Blob(["\uFEFF", e], { type: e.type }) : e;
    }
    function i(e, t, r) {
    ...
    function l(e) {
      try {
        ...
        t.initMouseEvent("click", true, true, window, 0, 0, 0, 80, 20, false, false, false, false, 0, null), e.dispatchEvent(t);
      }
    }
